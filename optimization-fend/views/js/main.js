...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    //Moved dx and newwidth variables outside of for loop to avoid looping
...
function updatePositions() {
  ...
  // brought initial var outside the for loop
  var items = document.getElementsByClassName('mover');
  var initial = document.body.scrollTop / 1250;

  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin(initial + (i % 5));
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //lowered count to 25 since only a handful of pizzas show. 200 seemed to be too much.
  for (var i = 0; i < 25; i++) {
